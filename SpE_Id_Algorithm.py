...
def save_results(run_name, Monthfolderstr, lev, lev_sl, timear, lat, intlat, lon, LTar, LTlong, time_ar_2wk, ds_months, Zavg_sl, altavg, altavg_sl, times_str_min, times_str_max, SpEs_Occ_Fr_b_dsavg, SpEs_Occ_Fr_b_avg, SpEs_Occ_Fr_bb_5d_dsavg, SpEsns_Occ_Fr_dsavg, SpEs, alt_sl_sh_avg_b_dsavg, alt_sl_sh_avg_b_dsavgLT, alt_sl_sh_avg_bb_5d_dsavg, Mptdens_avv1_b_5d, Mptdens_std, Mptdens_nsstd, SpEsns_freq_time, SpEs_freq_time, Mptdens_avg, Mptdens_nsdiff, Mptdens_nsavg, SpEs_Occ_Freq_llbav, SpEsns_Occ_Freq_llav, SpEsns_Occ_Freq_lat ):
    ...
    output_file = f'/home/home02/cm21cmr/SpE_Identification_Notebooks/New_Files/{str(run_name)}_SpE_Output_{str(Monthfolderstr)}_90-150km_{filename_append}.nc'
...
for set_idx in range(len(ds_months_sets)):  #loop through seasons
    ...
    time_it_shape, time_ind_2wk_min, time_ind_2wk_max, time_shape, timear, \
    lon_shape, LTshape, LTlong, lonar, LTar, LTlong, it_arr, lat_shape, latar, \
    newlat, newlat_shape, intlat, intlat_shape, intlat_ar, lev_sl_idx_min, \
    lev_sl_idx_max, lev_shape, levar, offset = setup_parameters()
    ...
    Mptdens_sh, Mptdens_diff, SpEs_sh_nan, Mptdens_avg_b, Mptdens_avv1_b, Mptdens_avv1_b_5d, \
    max_Mptdens_avv1_b_5d, Mptdens_avv1b5d_l, max_Mptdens_avv1b5d_l, Mptdens_avg_bb, \
    Mptdens_avg_bb_5d, Mptdens_avg_bb_5d_avg, Mptdens_avg_bb_5d_avglev, Mptdens_avg_bb_5d_dsavg, \
    Mptdens_avg_bb_5d_dsavglev, edens_sh, SpEs_e, maxSpEs__e, maxSpEs_e, foEs__m, foEs_m, foEs_m_av, \
    foEs_m_av_mth, foEs_m_av_ds, SpEs, SpEs_freq, SpEs_freq_time, SpEs_Occ_Freq, SpEs_Occ_Fr_b, \
    SpEs_Occ_Fr_b_avg, SpEs_Occ_Fr_b_dsavg, SpEs_Occ_Fr_b_avgLT, SpEs_Occ_Fr_b_dsavgLT, \
    SpEs_Occ_Fr_bb, SpEs_Occ_Fr_bb_5d, SpEs_Occ_Fr_bb_5d_avg, SpEs_Occ_Fr_bb_5d_dsavg, \
    SpEs_Occ_Fr_bb_5d_dsavglev, Mptdensns, Mptdens_nsavg, Mptdens_nsstd, Mptdens_nsdiff, \
    Mptdens_nsavv1_b, Mptdens_nsavv1_b_5d, max_Mptdens_nsavv1_b_5d, Mptdens_nsavv1b5d_l, \
    max_Mptdens_nsavv1b5d_l, edensns, SpEs_nse, maxSpEs__nse, maxSpEs_nse, foEsns__m, foEsns_m, \
    foEsns_m_av, foEsns_m_av_mth, foEsns_m_av_ds, SpEsns, SpEsns_freq_bool, SpEsns_freq, \
    SpEsns_freq_time, SpEsns_Occ_Freq, SpEsns_Occ_Fr_avg, SpEsns_Occ_Fr_dsavg, altavg, altavg_sl, \
    alt_sl_avg, alt_sl_aavg, alt_sl_aaavg, alt_sl_sh, alt_sl_sh_avg, alt_sl_sh_avg_b, alt_sl_sh_avg_b_avg, \
    alt_sl_sh_avg_b_dsavg, alt_sl_sh_avg_b_dsavgLT, alt_sl_sh_avg_b_avgLT, alt_sl_sh_avg_bb_5d, \
    alt_sl_sh_avg_bb_5d_avg, alt_sl_sh_avg_bb_5d_dsavg, alt_sl_sh_avg_bb ,SpEs_freq_altsum, \
    SpEs_freq_altsum_time, SpEs_Occ_Freq_ll, SpEs_Occ_Freq_llb, SpEs_Occ_Freq_llba, SpEs_Occ_Freq_llbav, \
    SpEsns_freq_altsum, SpEsns_freq_altsum_time, SpEsns_Occ_Freq_ll, SpEsns_Occ_Freq_lla, \
    SpEsns_Occ_Freq_llav  \
    = define_variables(lev_shape, time_shape, lat_shape, lon_shape, LTshape, time_it_shape, \
                       ds_months_shape, newlat_shape, intlat_shape, crit_freq_on)
    ...
    for ids in ds_months_ar:  #loop through months in season
        ...
        if run_name=='Jianfei_run':
            ...
            file1name=f'b0243/Data/Sporadic_E/Solar_Med/archive_yr2000c/ACP_CESM213_FX2000_f19_f19_mg16_Na_Fe_Mg_iontransport.cam.h0.0001-01.nc'
            ...
            file1name=f'b0243/Data/Sporadic_E/Solar_Max/archive_yr2000/atm/hist/SMax_3M_FX2000_f19f19mg16.cam.h0.0001-{ds_months[ids]}.nc'
            ds = xr.open_mfdataset(file1name)
        elif run_name=='SMin':
